...
<head>
    ...
    <title>MAJU JAYA AUTOPART | Admin</title>

    <!-- Custom fonts for this template-->
    <link rel="icon" href="<?=base_url('assets/img/admin/koperasi-logo.png') ?>" />
    <link href="<?=base_url('assets/js/admin/vendor/fontawesome-free/css/all.min.css') ?>" rel="stylesheet" type="text/css">
    <link
    ...
    <!-- JQuery -->
    <script src="<?=base_url('assets/js/admin/vendor/jquery/jquery.min.js') ?>"></script>

    <!-- Bootstrap core JavaScript-->
    <script src="<?=base_url('assets/js/admin/vendor/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">MAJU JAYA AUTOPART</div>
            </a>
            ...
            <?php 
                $master = in_array($highlight_menu, []);
            ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse <?= $master ? 'show' : '' ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-primary py-2 collapse-inner rounded">
                        <a class="collapse-item text-white <?= $highlight_menu === 'toko' ? 'active' : '' ?>" href="#!">Data Toko</a>
                    </div>
                </div>
            </li>
    ...
    <script src="<?=base_url('assets/js/admin/vendor/jquery-easing/jquery.easing.min.js') ?>"></script>
